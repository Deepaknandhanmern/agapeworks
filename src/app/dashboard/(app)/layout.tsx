...
import { LayoutDashboard, Newspaper, FolderKanban, Inbox, Users, Receipt, Mail, Package, Quote, Settings, Heart, ScrollText } from "lucide-react";
...
const navItems = [
  ...
  { label: "Wedly waitlist", href: "/dashboard/wedly", icon: Heart },
