...
const plans = [
  {
    ...
    description: "Up to 10 recoveries/month - see Vivira work before you commit to more.",
    popular: false,
    features: [
      { text: "Up to 10 recoveries/month", icon: <Database size={20} /> },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Revenue attribution + customer segmentation", icon: <Database size={20} /> },
    ],
  },
  {
    name: "Enterprise AI",
    ...
    description: "Everything in Pro, plus priority support as you scale.",
    popular: false,
    features: [
