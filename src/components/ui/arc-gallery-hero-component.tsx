      ...
      >
        ...
        <div className="absolute left-1/2 bottom-0 -translate-x-1/2">
          ...
          {images.map((src, i) => {
            ...
            // Rounded to avoid Node vs. browser Math.cos/sin producing
            // different floating-point precision, which mismatches the
            // server-rendered inline style string during hydration.
              ...
              >
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = `https://placehold.co/400x400/334155/e2e8f0?text=Agape+Works`;
                    }}
                  />
                </div>
              </div>
