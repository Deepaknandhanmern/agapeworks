...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    ...
    <span>Mobile Apps</span> <span className="text-secondary/60">✦</span>
    <span>SaaS Platforms</span> <span className="text-primary/60">✦</span>
    <span>AI Solutions</span> <span className="text-secondary/60">✦</span>
    <span>SEO &amp; AEO</span> <span className="text-primary/60">✦</span>
  </div>
);
