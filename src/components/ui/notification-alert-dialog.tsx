            ...
            {open && (
                <>
                    ...
                    <div
                        ...
                        aria-label="Notifications"
                    >
                        <div className="rounded-lg border-2 border-indigo-200 bg-white p-6 shadow-xl dark:border-indigo-900 dark:bg-gray-900">
                            ...
                            <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:space-x-2">
                                <Button
                                    variant="outline"
                                    onClick={() => setOpen(false)}
                                    className="mt-2 border-indigo-200 text-indigo-700 hover:bg-indigo-50 dark:border-indigo-800 dark:text-indigo-400 dark:hover:bg-indigo-900/40 sm:mt-0"
                                >
                                    Close
                                </Button>
                                <Button
