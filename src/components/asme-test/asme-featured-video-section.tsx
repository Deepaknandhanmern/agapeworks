    ...
    <section className="overflow-hidden bg-black px-6 pb-20 pt-6 md:pb-32 md:pt-10">
      ...
      >
        {FEATURED_VIDEO_SRC ? (
          ...
          <VideoPlaceholder label="featured video" />
        )}
        ...
        <div className="absolute bottom-0 left-0 right-0 flex flex-col gap-6 p-6 md:flex-row md:items-end md:justify-between md:p-10">
          <div className="asme-glass max-w-md rounded-2xl p-6 md:p-8">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="asme-glass w-fit rounded-full px-8 py-3 text-sm font-medium text-white"
          >
            Explore more
          </motion.button>
        </div>
