...
export function AsmeAboutSection() {
    ...
    <section className="relative overflow-hidden bg-black px-6 pb-10 pt-32 md:pb-14 md:pt-44">
      ...
      <div ref={ref} className="relative mx-auto max-w-5xl">
        ...
        <motion.h2
          ...
          className="mt-4 text-4xl leading-[1.1] tracking-tight text-white md:text-6xl lg:text-7xl"
        >
          Pioneering <em className={`${instrumentSerif.className} italic text-white/60`}>ideas</em> for
          <br className="hidden md:block" /> minds that{" "}
          <em className={`${instrumentSerif.className} italic text-white/60`}>
